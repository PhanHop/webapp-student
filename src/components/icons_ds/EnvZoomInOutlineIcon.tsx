...
const EnvZoomInOutlineIcon = ({
  ...
  return (
    ...
    >
      <g clipPath="url(#clip0_1384_4038)">
        <path
        ...
        />
        <path
          d="M11.2567 14.111L11.3111 6.9112C11.3147 6.43122 10.9679 6.00859 10.5679 6.00557C10.1679 6.00255 9.81474 6.4199 9.81112 6.89988L9.75678 14.0997C9.75316 14.5797 10.1 15.0023 10.5 15.0053C10.9 15.0083 11.2531 14.591 11.2567 14.111Z"
          fill={fill}
        />
      </g>
      <defs>
        <clipPath id="clip0_1384_4038">
...
export default memo(EnvZoomInOutlineIcon);
